...
- **Backend & APIs:** Spring, FastAPI, REST
...
- Provided on-call customer support and incident response across eight global data centres.
- Helped design and implement scalability improvements for a session-management REST service.
- Developed a Redis-backed IPAM REST service in Python using FastAPI and AWS ElastiCache, with extensive unit and integration test coverage using Pytest.
- Designed, implemented, and supported a Go HTTP service that published connected-user data to an AWS SNS topic.

#### Cisco Expressway | 2018 – 2020
- Developed and tested security features including a forbidden-password dictionary using Python and PHP.
- Created automated test coverage with Python unit tests and Selenium UI tests.
- Investigated customer issues using logs and packet captures.
